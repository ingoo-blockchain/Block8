...
async function addState(value) {
    try {
        // const instance = new Comment(value) // ajax
        // state.push(instance) // C
        const content = value
        // request({ method: "post", path: "/comments", body: { content } }, (instance) => {
        //     state.push(instance)
        //     setTotalRecord()
        //     drawing()
        // })
        ...
        const instacne = await request({ method: "post", path: "/comments", body: { content } })
        state.push(instacne)
        setTotalRecord()
        drawing()
    } catch (e) {
